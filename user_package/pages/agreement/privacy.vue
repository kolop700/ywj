    ...
    <view class="content">
      ...
      <view class="section">
        ...
        <view class="section-content">
          ...
          <view>(d) 履行法定义务所必需的，如反洗钱、实名管理等相关法律法规要的必要信息；</view>
          <view>(e) 与犯罪侦查、起诉、审判何判决执行等直接相关的；</view>
          <view>(f) 所收集的个人信息是您自己公开的；</view>
          <view>(g) 用于维护所提供的服务的安全稳定运行所必须的，如：发现、处置产品或服务故障；</view>
          <view>(h) 法律法规规定的其他情形。</view>
          <view>需要注意的是，当您的个人信息处理属于(b)至(h)项情形时，我们可能会依所适用法律法规的要求而无需再征得您的同意。</view>
        </view>
      </view>
      ...
      <view class="section">
        ...
        <view class="section-content">
          ...
          <view>• 确认注销后，您的账号将进入注销流程。</view>
          <view>3. 数据保留：</view>
          <view>• 账号注销后，您的个人数据将被保留30天；</view>
          <view>• 30天后，您的个人数据将被永久删除，且无法恢复。</view>
          <view>4. 注销影响：</view>
          <view>• 注销后，您将无法使用该账号登录和使用相关服务；</view>
          <view>• 注销前请确保已处理完所有相关业务；</view>
          <view>• 注销后，您需要重新注册才能使用我们的服务。</view>
        </view>
      </view>
      ...
      <view class="section">
        <view class="section-title">第二条 定义</view>
        <view class="section-content">
          <view>1、人脸采集：指用户通过上传本地相册图片、自拍完成本人人脸图片的采集，并完成与您的一卡通帐户信息绑定。</view>
          <view>2、刷脸服务：指用户开通刷脸服务并完成人脸图片的采集后，用户可通过在商家处扫描人脸即识别您的一卡通账户信息，并完成相关O2O服务。</view>
          <view>3、O2O服务：指在本服务关联终端设备中开展的消费、充值、门禁出入、自助服务等。</view>
        </view>
      </view>

      <view class="section">
        <view class="section-title">第三条 基础条款</view>
        <view class="section-content">
          <view>1、您同意，在您开通刷脸服务后，本服务需要采集并保存您的脸部图片。您应根据页面的提示上传您本人的照片，系统判断您的照片符合要求后，即可完成脸部信息采集。</view>
          <view>2、您同意，不采取违法、不正当或欺骗手段（如上传非本人照片等）使用本服务。否则服务提供方有权停止对您的服务，由此产生的所有法律后果及损失均由您本人承担。</view>
          <view>3、您同意，为方便您在不同关联设备更快捷方便使用本服务，同时也为提升本服务的安全性与准确性，服务提供方可对您的人脸信息做必要的优化处理。</view>
          <view>4、服务提供方将应严格按照法律法规有关个人隐私的规定，对您的个人信息进行严格保密。但如因不可抗力、计算机黑客袭击、系统故障、通讯故障、电脑病毒、恶意程序攻击及其他不可归因于服务提供方的情况而导致您信息泄露的，服务提供方不承担任何责任。</view>
        </view>
      </view>

      <view class="section">
        <view class="section-title">第四条 特别约定</view>
        <view class="section-content">
          <view>1、您开通刷脸服务后，可在开通了刷脸服务的关联设备处直接通过支持扫脸的设备扫描您的人脸直接完成O2O服务，而不需要输入一卡通账户密码。</view>
          <view>2、您理解并同意，您使用刷脸服务扫描您人脸的行为，视为您向本服务发出了不可撤销地支付、开门等指令，且该行为与您使用一卡通账户、密码的行为具有相同的法律效力。</view>
          <view>3、服务提供方将在现有技术能力上保障刷脸服务的有效、正常运行，并将尽力提升刷脸服务的准确性。但是，由于人脸采集信息容易受表情、妆容、环境等多种不特定因素影响，而且服务提供方采集到的信息范围相对有限、技术水平与认证手段也在不断升级改造中，服务提供方无法保证每个用户每次刷脸服务的成功性。</view>
          <view>4、您理解，在法律允许范围内，服务提供方对下列情形导致的服务中断或受阻，以及由此给您带来的风险及损失将不承担责任：</view>
          <view>（1）本服务正常停机维护或升级；</view>
          <view>（2）因不可抗力、计算机黑客袭击、系统故障、通讯故障、电脑病毒、恶意程序攻击等原因；</view>
          <view>（3）您手机等使用终端设备出现故障、或因您对本服务使用不当造成；</view>
          <view>（4）法律法规或本协议规定的其他情形。</view>
        </view>
      </view>

      <view class="section">
        <view class="section-title">第五条 争议的解决</view>
        <view class="section-content">
          <view>双方在履行本协议的过程中，如发生争议，应协商解决。协商不成的，任何一方均可向服务提供方所在地有管辖权的人民法院提起诉讼。</view>
        </view>
      </view>

      <view class="section">
        <view class="section-title">第六条 协议的解释</view>
        <view class="section-content">
